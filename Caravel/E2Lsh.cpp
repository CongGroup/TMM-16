...
void E2Lsh::InitLSH(double r,uint32_t d, uint32_t l, uint32_t k, double w)
{
    m_dW = w;
    m_dR = r;
    m_uiD = d;
...
void E2Lsh::ComputeLSH(double *ardMatrix, uint32_t *aruiRet)
{
...
double E2Lsh::ComputeL2(double *ardX, double *ardY, uint32_t uiD)
{
    double dRet = 0;
...
double E2Lsh::ComputeCos(double *ardX, double *ardY, uint32_t uiD)
{
    double dRet = 0;
    double dA = 0;
    double dB = 0;
...
uint32_t E2Lsh::genUint32Random(uint32_t uiRangeStart, uint32_t uiRangeEnd)
{
...
double E2Lsh::genGaussianRandom()
{
...
double E2Lsh::genUniformRandom(double dRangeStart, double dRangeEnd)
{
